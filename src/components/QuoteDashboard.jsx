...
export default function QuoteDashboard({ showToast }) {
  ...
  return (
    <div>
      {/* 기간 탭 + 기준 라벨 */}
      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:14, padding:"12px 16px", background:"#fff", border:"1px solid var(--border)", borderRadius:10 }}>
      ...
      {/* 국내/해외 요약 - 하나의 카드로 묶기 */}
      <div style={{ background:"#fff", border:"1px solid var(--border)", borderRadius:10, padding:"14px 16px", marginBottom:16 }}>
        {/* 국내 */}
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:8, marginBottom:14, paddingBottom:14, borderBottom:"1px solid var(--border)" }}>
          {[
            ...
            <div key={label} style={{ background:"#F0F6FE", borderRadius:8, padding:"10px 14px" }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:8 }}>
          {[
            ...
            <div key={label} style={{ background:"#F0FAF5", borderRadius:8, padding:"10px 14px" }}>
      ...
      {/* 필터 바 */}
      <div style={{ background:"#fff", border:"1px solid var(--border)", borderRadius:10, padding:"14px 16px", marginBottom:16, display:"flex", gap:10, alignItems:"flex-end", flexWrap:"wrap" }}>
        {[
      ...
      {!loading && periodKeys.map(key => {
        ...
        return (
          <div key={key} style={{ marginBottom:16 }}>
            {/* 기간 헤더 */}
            <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:8, padding:"8px 14px", background:"#fff", border:"1px solid var(--border)", borderRadius:8 }}>
